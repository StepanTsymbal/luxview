...
public class AppTest extends TestCase {
	...
	DataAnalyzer dataAnalyzer = new DataAnalyzer(new File(PATH_TO_FILE));
    ...
    public void testGetFilteredList() {
    	...
    	assertEquals(dataAnalyzer.getFilteredList(testString), sortedList);
    }
    ...
    public void testGetAverageWordLength() {
    	...
    	sortedList1.add("22");
    	sortedList1.add("333");
    	assertEquals(dataAnalyzer.getAverageWordLength(sortedList1), 2.0);
    	
    	List<String> sortedList2 = new ArrayList<>();
    	sortedList2.add("1");
    	sortedList2.add("");
    	sortedList2.add("333");
    	assertEquals(dataAnalyzer.getAverageWordLength(sortedList2), 4/3.0);
    }
    
    public void testGetAllLinesFromFile() {
    	
    	List<LineInfo> lineInfoList = dataAnalyzer.getAllLinesFromFile(PATH_TO_FILE);
